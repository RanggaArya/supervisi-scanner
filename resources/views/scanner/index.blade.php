...
<head>
    ...
    <style>
        ...
        #reader video { object-fit: cover !important; border-radius: 3rem; transform: scale(1.05); }
...
<body class="antialiased overflow-hidden">
    ...
    <div class="mobile-content min-h-screen flex flex-col relative">
            ...
            <div class="flex justify-between items-start relative z-10">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 bg-white p-0.5 rounded-2xl shadow-2xl flex-shrink-0">
                        <img src="{{ asset('logo.png') }}?v=2" alt="Logo" class="w-full h-full object-contain rounded-xl">
                    </div>
                    <div>
                        <h1 class="text-white font-extrabold text-lg leading-tight uppercase tracking-tighter italic">RSU Mitra</h1>
                        <h1 class="text-indigo-400 font-extrabold text-lg leading-tight uppercase tracking-tighter italic">Paramedika</h1>
                        <div class="mt-2 inline-flex items-center bg-indigo-500 text-white text-[9px] font-black px-2.5 py-1 rounded-lg tracking-widest uppercase shadow-lg shadow-indigo-500/20">
                ...
                <div class="flex flex-col items-end gap-3 text-right">
                    <div class="flex flex-col items-end">
                        <span class="text-slate-400 text-[10px] font-bold uppercase tracking-wider leading-none mb-1">Supervisor</span>
                        <span class="text-white text-xs font-extrabold uppercase truncate max-w-[100px]">{{ $userName }}</span>
                    </div>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="bg-red-500/10 border border-red-500/20 px-4 py-2 rounded-xl text-red-400 text-[10px] font-black uppercase flex items-center gap-2 active:scale-95 transition-all">
        ...
        <main class="flex-1 px-8 -mt-14 relative z-20">
            <div class="relative group">
                ...
                <div class="bg-slate-900 rounded-[4rem] p-5 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.8)] ring-1 ring-white/10">
                    ...
                    <div class="text-center pt-8 pb-4">
                        ...
                        <h3 class="text-slate-200 font-extrabold text-xs uppercase tracking-[0.4em] mb-2 leading-none">Scanning Engine</h3>
            ...
            <div class="mt-10 grid grid-cols-2 gap-4">
                ...
                <div class="info-pill p-4 rounded-3xl flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] font-bold text-emerald-400 uppercase tracking-tighter italic leading-none mt-1">Online</p>
                    </div>
                </div>
            </div>
        </main>
        ...
        <footer class="py-12 text-center">
            <p class="text-[9px] text-slate-600 font-black uppercase tracking-[0.6em]">RSU MITRA PARAMEDIKA &copy; 2026</p>
        </footer>
    </div>
    ...
    <div id="detailModal" class="modal fixed inset-0 z-[100] hidden">
        ...
        <div class="bottom-sheet absolute bottom-0 left-0 right-0 rounded-t-[4rem] max-h-[85vh] flex flex-col shadow-2xl">
            <div class="w-12 h-1 bg-white/10 rounded-full mx-auto my-6"></div>
            
            <div class="px-10 pb-6">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-2xl bg-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-600/40 text-white">
                        <i data-lucide="search" class="w-6 h-6 text-white"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-extrabold text-white tracking-tighter uppercase leading-none">Aset Terdeteksi</h3>
                        <p class="text-[9px] font-black text-indigo-400 mt-2 tracking-widest uppercase italic">Database Sync Active</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 pb-12 flex gap-4">
                <button onclick="openNoteSheet()" class="flex-1 bg-indigo-600 text-white font-black py-5 rounded-3xl shadow-xl shadow-indigo-600/30 active:scale-95 transition-all text-xs uppercase tracking-[0.2em]">
                    KONFIRMASI ASET
                </button>
                <button onclick="closeModal()" class="w-16 h-16 bg-white/5 border border-white/10 rounded-3xl flex items-center justify-center text-slate-400 active:scale-90 transition-all">
    ...
    <div id="noteModal" class="modal fixed inset-0 z-[110] hidden">
        ...
        <div id="noteSheet" class="absolute bottom-0 left-0 right-0 bg-slate-900 rounded-t-[4rem] border-t border-white/10 p-10 shadow-2xl translate-y-full">
            ...
            <div class="relative mb-8">
                <textarea id="catatanInput" 
                    ...
                    rows="3" 
                    placeholder="Tuliskan detail kondisi perangkat..."></textarea>
            </div>

            <div class="flex gap-4">
                <button onclick="supervisi()" id="finalBtn" class="flex-1 bg-emerald-500 text-white font-black py-5 rounded-3xl shadow-xl shadow-emerald-500/20 active:scale-95 transition-all text-xs uppercase tracking-[0.2em]">
                    SIMPAN LOG
                </button>
                <button onclick="closeNoteSheet()" class="w-16 h-16 bg-white/5 border border-white/10 rounded-3xl flex items-center justify-center text-slate-400">
